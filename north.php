...
if(isset($_POST['name'])){
    ...
    $phone = $_POST['phone'];
    $desc = $_POST['desc'];
    $sql = "INSERT INTO `iiitk_travel`.`tbl_main` (`name`, `age`, `gender`, `email`, `phone`, `desc`, `dt`) VALUES ('$name', '$age', '$gender', '$email', '$phone', '$desc', current_timestamp());";
    //echo $sql;
...
<body background="bg.jpg">
 ...
 <div class="container">
     <h1>Welcome to IIIT Kottayam North-India Tour Form</h1>
