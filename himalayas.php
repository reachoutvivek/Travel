...
if(isset($_POST['name'])){
    ...
    $phone = $_POST['phone'];
    $desc = $_POST['desc'];
    $sql = "INSERT INTO `iiitk_travel`.`tbl_himalayas` (`name`, `age`, `gender`, `email`, `phone`, `desc`, `dt`) VALUES ('$name', '$age', '$gender', '$email', '$phone', '$desc', current_timestamp());";
...
<body background="himalayas.jpg">
    <!--<img class="image" src="bg.jpg" alt="iiitkottayam">-->
 <div class="container">
     <h1>Welcome to IIIT Kottayam Himalayas Trip Form</h1>
    <!-- <p>Wanna check out the most beautiful places and piligrimages of North-India?? join us</p>-->
     <?php
        if($insert == true){
        echo "<p class='submitMsg'>Thanks for submitting your form. We are happy to see you joining us for the IIITK Himalayas trip</p>";
        }
    ?>
     <form action="himalayas.php" method="post">
